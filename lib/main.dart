...
import 'package:mobile_apps/presentation/viewmodels/resto/create_food_place_view_model.dart';
...
import 'package:mobile_apps/presentation/views/resto_food/create_food_place_screen.dart';
    ...
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (context) =>
              MapViewModel(apiService: context.read<ApiService>()),
        ),
        ChangeNotifierProvider(
          create: (context) =>
              FoodPlaceDetailViewModel(apiService: context.read<ApiService>()),
        ),
        ChangeNotifierProvider(
          create: (context) =>
              UpdateFoodPlaceViewModel(apiService: context.read<ApiService>()),
        ),

        ChangeNotifierProvider(
          create: (context) =>
              CreateFoodPlaceViewModel(apiService: context.read<ApiService>()),
        ),
      ...
      builder: (context, themeProvider, child) {
        return MaterialApp(
          ...
          routes: {
            ...
            NavigationRoute.mapFoodPlaceRoute.path: (context) => MapScreen(),
            NavigationRoute.editFoodPlaceRoute.path: (context) =>
                EditFoodPlaceScreen(),
            NavigationRoute.createFoodPlace.path: (context) =>
                CreateFoodPlaceScreen(),
          },
